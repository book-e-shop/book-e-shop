...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 30 2020 г., 20:24
...
INSERT INTO `comments` (`id`, `book_id`, `user_id`, `comment`, `publish_date`) VALUES
(4, 1, 5, 'Неплохой детектив.', '2020-12-30');
...
CREATE TABLE `logs` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL,
  `action` enum('Чтение','Добавление','Удаление','Редактирование') DEFAULT NULL,
  `table` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `logs` (`id`, `user_id`, `action`, `table`, `table_id`, `publish_date`) VALUES
(1, 5, 'Чтение', 'users', 5, '2020-12-30 21:35:44'),
(2, 5, 'Чтение', 'users', 5, '2020-12-30 21:46:46'),
(3, 5, 'Чтение', 'users', 5, '2020-12-30 22:22:41'),
(4, 5, 'Добавление', 'rating', 1, '2020-12-30 22:22:51'),
(5, 5, 'Добавление', 'comments', 4, '2020-12-30 22:23:11');
...
CREATE TABLE `orders` (
  ...
  `book_id` int(10) UNSIGNED DEFAULT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL,
  `payment_method` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `orders` (`id`, `order_id`, `book_id`, `user_id`, `payment_method`, `address`, `add_date`) VALUES
(3, 1, 1, 5, 'Картой курьеру', 'ул. Авиаторов 40', '2020-12-30'),
(4, 1, 2, 5, 'Картой курьеру', 'ул. Авиаторов 40', '2020-12-30');
...
INSERT INTO `rating` (`id`, `book_id`, `user_id`, `rating`, `publish_date`) VALUES
(1, 1, 5, 4, '2020-12-30');
...
(3, 'admin', 'admin@gmail.com', 'Андрей', 'Найденко', '$2y$10$hzsjlf9Ncpn86gjqXu8oL.socxQ6Ux.JHvaYcj/y.8oI8lboq9Uui'),
(4, 'usver', 'mail@mail.ru', 'Пупкин', 'Василий', '$2y$10$JD0JQJfnqhhlVT49M7oRuednd6yFtaHO1/OYeUMRq2zOHNjFQ88Z.'),
(5, 'vasil', 'vasya@mail.ru', 'Вася', 'Пупкин', '$2y$10$5d62XTDpGNWUj0yaD95gLO1qak345KyBF2bIznGTpNOtHLPIILuDK');
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `rating`
  ADD CONSTRAINT `rating_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE,
